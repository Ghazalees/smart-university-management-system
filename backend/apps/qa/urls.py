...
from .views import AnalyzeRequestView, MyQuestionsView, QuestionAnswerView, QuestionCreateView, QuestionDetailView, QuestionHistoryView
urlpatterns = [
    ...
    path("questions/<int:pk>/history", QuestionHistoryView.as_view(), name="question-history"),
